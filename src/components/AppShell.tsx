    ...
    <div className="min-h-screen bg-proof flex flex-col">
      <header className="bg-white border-b border-rule h-12 flex items-center px-4 shrink-0">
        <div className="flex items-center gap-2 mr-8">
          ...
          <span className="font-mono text-xs tracking-widest uppercase text-ink font-semibold"><span className="text-[10px] font-normal normal-case tracking-normal opacity-50 mr-1.5">V1.0</span>SchemaForge</span>
        </div>
